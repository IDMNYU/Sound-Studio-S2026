...
- Installing Max:
    ...
    2. Download and install the Sassafras client: [Windows](https://download.sassafras.com/software/release/current/Installers/Windows/Client/ksp-client-x64.exe) | [Mac](https://download.sassafras.com/software/release/current/Installers/MacOS/Client/ksp-client.pkg)
