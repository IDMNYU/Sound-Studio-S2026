...
,
		"classnamespace" : "box",
		"rect" : [ 1491.0, 411.0, 1000.0, 780.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"boxes" : [ 			{
				"box" : 				{
					"basictuning" : 440,
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 208.0, 46.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 109.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 349.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 328.0, 152.0, 24.0, 24.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 233.0, 152.0, 47.0 ],
					"text" : "double-click top open your subpatcher in a separate window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 179.0, 150.0, 47.0 ],
					"text" : "THIS IS A SUBPATCHER!\n[p (your subpatcher name)]"
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 2053.0, 431.0, 1000.0, 780.0 ],
						"gridsize" : [ 15.0, 15.0 ],
						"boxes" : [ 							{
								"box" : 								{
									"id" : "obj-5",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 440.0, 211.0, 153.0, 87.0 ],
...
,
					"patching_rect" : [ 253.0, 195.0, 94.0, 22.0 ],
